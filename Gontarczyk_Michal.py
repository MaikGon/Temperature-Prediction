...
def main():
    ...
    while current < stop:
        ...
        df_temperature_resampled.loc[current, 'predicted'] = predicted_temperature

    print(metrics.mean_squared_error(df_temperature_resampled['value'], df_temperature_resampled['predicted']))
